...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function PrintBill() {
            var PGrid = document.getElementById('<%=BillsList.ClientID%>');
            PGrid.bordr = 0;
            var PWin = window.open('', 'PrintGrid', 'left=100, top=100, width=1024, height=768, tollbar=0, scrollbar = 1,status=0,reizable')
            ...
            <div class="col-md-7">
               <h4 class="text-center" style="color:teal;">Clinet's Bill</h4>
                ...
                <SortedDescendingHeaderStyle BackColor="#00547E" />
                    ...
                    <asp:Button Text="Print" ID="PrintBtn" runat="server" OnClientClick="PrintBill()" BackColor="teal" class="btn-warning btn-block btn" OnClick="PrintBtn_Click" />
                 </div>               
                </div>
            </div>
        </div>
